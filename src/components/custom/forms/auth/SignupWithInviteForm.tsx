...
import { InvitedSignupFormSchema } from "@/lib/zod/schema";
import { Info, SpinnerGap } from "@phosphor-icons/react";
import { useSignupUserWithInvite } from "@/hooks/auth/useSignupUserWithInvite";
import { PasswordInput } from "../../inputs/PasswordInput";

export function SignupWithInviteForm() {
    const form = useForm<InvitedSignupFormSchemaTypes>({
        resolver: zodResolver(InvitedSignupFormSchema),
        mode: "onChange",
        defaultValues: {
            email: "",
            password: "",
    ...
    const { mutate, isPending } = useSignupUserWithInvite();

    const onSubmit = (data: InvitedSignupFormSchemaTypes) => {
        mutate(data);
        form.reset();
    };
