...
import { SpinnerGap, Chat } from "@phosphor-icons/react/dist/ssr"; // Import Chat icon
...
export function PromptChartsDialog({ promptId }: PromptFeedbackDialogProps) {
        ...
        <Dialog>
            <DialogTrigger asChild>
                <Button size="icon" variant="outline" className="size-7">
                    <Chat weight="duotone" className="size-4" /> {/* Changed to Chat icon */}
