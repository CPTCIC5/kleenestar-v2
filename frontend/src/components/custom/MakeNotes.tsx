			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)}>
					<DialogContent className="max-w-[660.61px] w-full">
						...
						<Card>
							<CardContent className="py-[24px] overflow-auto scrollbar-hide max-xl:h-[200px]   ">
								{note}
							</CardContent>
						</Card>

						<div className="py-[10px] flex justify-between">
							<div className=" font-mainhead text-[15px] text-foreground">
								Note
							</div>
								...
								<Card className="fixed right-10  group-hover:block hover:block hidden bg-foreground text-background py-[10px] mx-2 px-[20px]  ">
									<div className="flex gap-4 items-center">
										<div
											...
											className="w-[20px] hover:scale-125 border-background h-[20px] rounded-full bg-green-500"></div>
										<div
											onClick={() => {
												setColor("FFCCCC")
											}}
											className="w-[20px] hover:scale-125 h-[20px] rounded-full bg-red-500"></div>
										<div
											onClick={() => {
												setColor("D3D3D3")
											}}
											className="w-[20px] hover:scale-125 h-[20px] rounded-full bg-gray-500"></div>
										<div
											onClick={() => {
												setColor("E6E6FA")
											}}
											className="w-[20px] hover:scale-125 h-[20px] rounded-full bg-violet-500"></div>
										<div
											onClick={() => {
												setColor("ADD8E6")
											}}
											className="w-[20px] hover:scale-125 h-[20px] rounded-full bg-blue-500"></div>
									</div>
								</Card>
