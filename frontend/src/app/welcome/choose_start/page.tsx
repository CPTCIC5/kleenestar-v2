    ...
    return (
			<div className="relative animate-fade-in-up  max-xl:pt-10 pt-[5%]">
				...
				<div className="animate-fade-in-up max-xl:px-10">
					...
					<div className="text-[30px] text-center font-bold text-black font-mainhead pt-4">
						{"Let's get started"}
					</div>
					<div className="w-[45%] max-xl:w-[90%] mx-auto pt-4 font-montserrat text-gray-700">
					...
					<div className="flex mx-auto gap-[5%] w-fit pt-10 max-xl:flex-col pb-10">
						<Link href="/login">
							<Card className={cn("h-[310px] w-[300px]")}>
								<CardContent className={cn("p-0 h-[260px]")}>
									<Image
										className="w-[90%] mx-auto"
										src={workspace}
										alt={"workspace"}></Image>
								</CardContent>
								<p className="text-center w-full mb-10">I have a workspace</p>
							</Card>
						</Link>
						<Link href="/workspace">
							<Card className={cn("h-[310px] w-[300px]")}>
