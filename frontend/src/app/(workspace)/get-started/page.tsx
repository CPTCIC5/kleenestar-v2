...
export default function GetStarted() {
    return (
        <div>
            ...
            <div className="relative h-full flex flex-col animate-fade-in-up  w-fit  mx-auto pt-[10%] max-xl:pt-[30%] z-20">
                ...
                <div className=" px-[15%] text-center">
                    <p>
                        Kleenestar help you get valuable insights from your marketing campaings and
